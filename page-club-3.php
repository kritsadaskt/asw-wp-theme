			...
			<div class="lg:col-span-3">
				...
				<section id="club-menu" class="col-span-3 lg:pl-6 lg:pb-10 pt-4">
					...
					$club_type_2 = array(
						...
						// [
						// 	"name"=> "ชวนเพื่อนซื้อโครงการกับเรา",
						// 	"link"=> ""
						// ],
						[
							"nameTH"=> "สิทธิพิเศษ",
						...
						[
							"nameTH"=> "สมัครเป็นพาร์ทเนอร์กับเรา",
							"nameEN"=> "Grow Together",
							"link"=> "/grow-together"
						],
					)
					?>
					...
					<?php $i = 0; foreach ($club_type_2 as $cv): $i++; ?>
...
<div class="lg:col-span-9 -overflow-auto -scroll-hid">
	...
	<!-- <div id="club-fgf" class="py-6 club-wrap">
		...
		<sp class="l hidden lg:block"></sp>
		<form id="asw_club_referrer_form" action="">
			<h3 class="text-2xl font-medium"><?php pll_e('ข้อมูลผู้แนะนำ'); ?></h3>
			...
			<div class="h-10"></div>
			<h3 class="text-2xl font-medium"><?php pll_e('ข้อมูลผู้ถูกแนะนำ'); ?></h3>
			...
			<button id="submit" type="submit" class="rounded bg-[#F1683B] text-2xl text-white px-5 py-2 w-fit mt-3">
				<?php pll_e('ส่งข้อมูล'); ?>
			</button>
		</form>
	</div> -->
	...
	<div id="club-privilege" class="py-6 club-wrap">
		<h2 class="font-medium"><?php pll_e('ASSETWISE PRIVILEGE')?></h2>
		<p><?php pll_e('พบกับ 7 หมวดสิทธิพิเศษ ที่จะพาคุณสุข ครบ จบทุกมิติ — เฉพาะลูกบ้าน​แอสเซทไวส์ เท่านั้น!')?></p>
		<sp class="l hidden lg:block"></sp>
		<div class="privilege-wrapper">
			<div class="privilege-tabs">
				<div class="tab-navigation-wrapper">
					<!-- Desktop Navigation -->
					<div class="tab-navigation hidden md:flex">
						<button class="tab-btn active" data-tab="tab-1" style="flex-shrink: 0;">HEALTH & WELLNESS</button>
						<button class="tab-btn" data-tab="tab-2" style="flex-shrink: 0;">HOME & LIVING</button>
						<button class="tab-btn" data-tab="tab-3" style="flex-shrink: 0;">SERVICE & LIFESTYLE</button>
						<button class="tab-btn" data-tab="tab-4" style="flex-shrink: 0;">LEARNING</button>
						<button class="tab-btn" data-tab="tab-5" style="flex-shrink: 0;">DINING & CAFE</button>
						<button class="tab-btn" data-tab="tab-6" style="flex-shrink: 0;">TRAVEL</button>
						<button class="tab-btn" data-tab="tab-7" style="flex-shrink: 0;">PET</button>
					</div>
					
					<!-- Mobile Dropdown Navigation -->
					<div class="h-7 md:hidden"></div>
					<div class="tab-navigation-mobile md:hidden relative">
						<button class="tab-dropdown-btn w-full px-4 py-2 text-left border border-gray-300 rounded bg-white flex justify-between items-center" onclick="toggleTabDropdown()">
							<span id="selected-tab-text">HEALTH & WELLNESS</span>
							<svg class="w-4 h-4 transform transition-transform" id="dropdown-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
							</svg>
						</button>
						<div class="tab-dropdown-menu absolute top-full left-0 w-full bg-white border border-gray-300 rounded mt-1 z-10 hidden" id="tab-dropdown-menu">
							<button class="tab-btn-mobile w-full px-4 py-2 text-left hover:bg-gray-100 active" data-tab="tab-1" onclick="selectTab(this, 'HEALTH & WELLNESS')">HEALTH & WELLNESS</button>
							<button class="tab-btn-mobile w-full px-4 py-2 text-left hover:bg-gray-100" data-tab="tab-2" onclick="selectTab(this, 'HOME & LIVING')">HOME & LIVING</button>
							<button class="tab-btn-mobile w-full px-4 py-2 text-left hover:bg-gray-100" data-tab="tab-3" onclick="selectTab(this, 'SERVICE & LIFESTYLE')">SERVICE & LIFESTYLE</button>
							<button class="tab-btn-mobile w-full px-4 py-2 text-left hover:bg-gray-100" data-tab="tab-4" onclick="selectTab(this, 'LEARNING')">LEARNING</button>
							<button class="tab-btn-mobile w-full px-4 py-2 text-left hover:bg-gray-100" data-tab="tab-5" onclick="selectTab(this, 'DINING & CAFE')">DINING & CAFE</button>
							<button class="tab-btn-mobile w-full px-4 py-2 text-left hover:bg-gray-100" data-tab="tab-6" onclick="selectTab(this, 'TRAVEL')">TRAVEL</button>
							<button class="tab-btn-mobile w-full px-4 py-2 text-left hover:bg-gray-100" data-tab="tab-7" onclick="selectTab(this, 'PET')">PET</button>
						</div>
					</div>
					...
					function selectTab(button, tabText) {
						// Update selected text
						document.getElementById('selected-tab-text').textContent = tabText;
						...
						// Trigger tab change (you may need to adapt this to your existing tab functionality)
					...
					document.addEventListener('click', function(event) {
						const dropdown = document.querySelector('.tab-navigation-mobile');
				...
				<div class="tab-content">
					<div class="tab-panel active" id="tab-1">
						...
						<p><?php pll_e('ดูแลสุขภาพกายและใจ เติมพลังชีวิตในทุกวัน')?></p>
						<div class="h-10"></div>
						<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-flow-row gap-4 md:gap-7">
							<?php
							$args = array(
					...
					<div class="tab-panel" id="tab-2">
						<h3>HOME & LIVING</h3>
						<p><?php pll_e('“อยู่สบาย ใจสบาย” ดูแลทุกความสุขในบ้าน ด้วยส่วนลดของตกแต่ง เฟอร์นิเจอร์ เครื่องใช้ไฟฟ้า และบริการดูแลที่อยู่อาศัย')?></p>
						<div class="h-10"></div>
						<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-flow-row gap-4 md:gap-7">
							<?php
							$args = array(
					...
					<div class="tab-panel" id="tab-3">
						<h3>SERVICE & LIFESTYLE</h3>
						<p><?php pll_e('“ชีวิตดี ครบ จบในคลับเดียว” จากบริการด้านสุขภาพและความงาม ฟิตเนส ไปจนถึงบริการรถเช่า ล้างรถ ประกันภัยต่างๆ รวมทุกบริการที่ตอบโจทย์ทุกไลฟ์สไตล์')?></p>
						<div class="h-10"></div>
						<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-flow-row gap-4 md:gap-7">
							<?php
							$args = array(
					...
					<div class="tab-panel" id="tab-4">
						<h3>LEARNING</h3>
						<p><?php pll_e('“เรียนรู้เพื่อชีวิตที่เติบโต” มอบสิทธิพิเศษด้านการเรียนรู้ทั้งเด็กและผู้ใหญ่ เช่น คอร์สออนไลน์ การพัฒนาทักษะด้านต่างๆ')?></p>
						<div class="h-10"></div>
						<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-flow-row gap-4 md:gap-7">
							<?php
							$args = array(
					...
					<div class="tab-panel" id="tab-5">
						<h3>DINING & CAFE</h3>
						<p><?php pll_e('“กินดี มีดีล”รวมร้านอาหาร คาเฟ่ ทั้งร้านขนาดเล็ก-ใหญ่ และบริการเดลิเวอรี่ชั้นนำ พร้อมส่วนลดพิเศษเพื่อทุกมื้อของคุณ')?></p>
						<div class="h-10"></div>
						<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-flow-row gap-4 md:gap-7">
							<?php
							$args = array(
					...
					<div class="tab-panel" id="tab-6">
						<h3>TRAVEL & LIFSTYLE</h3>
						<p><?php pll_e('เปิดประสบการณ์ใหม่กับการเดินทางและไลฟ์สไตล์ที่คัดสรร เที่ยวแบบมีสิทธิ์สิทธิประโยชน์สำหรับการท่องเที่ยว ทั้งที่พัก โรงแรมบรรยากาศสุดชิล')?></p>
						<div class="h-10"></div>
						<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-flow-row gap-4 md:gap-7">
							<?php
							$args = array(
					...
					<div class="tab-panel" id="tab-7">
						<h3>PET & FRIEND</h3>
						<p><?php pll_e('สิทธิพิเศษสำหรับคนรักสัตว์เลี้ยง ทั้งสินค้า บริการ และกิจกรรมที่สร้างความสุขให้คุณและเพื่อนขนฟู')?></p>
						<div class="h-10"></div>
						<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-flow-row gap-4 md:gap-7">
							<?php
							$args = array(
...
<script type="text/javascript">
	...
	function show_info(num) {
		if (num === 5) {
			window.location.href = 'https://assetwise.co.th/grow-together/'
			return;
		}
		toFilterTop()

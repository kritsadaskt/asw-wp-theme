	...
	<div class="section-fade">
		...
		if ($content['promotion_image']['id'] != '') {
			if ($form_pattern == 'fix' && $form_type != 'bottom') {
				...
				<div class="container mx-auto">
					<div class="grid grid-cols-12 items-center">
						<?php if ($form_type == 'left'): ?>
							<div class="col-span-6 px-8 xl:px-0-" style="background-image:url(<?= $content['form_bg']['sizes']['large'] ?>)">
								<div class="form-template form-1">
				...
				<div class="col-span-6 px-8 xl:px-0-">
					<div class="form-template form-1">
						<h2 class="form-title">ลงทะเบียน</h2>
						<?= $content['form'] ?>
					</div>
...
<script type="text/javascript">
	...
	function setFormSelector(){
		...
		let skey = 0;
		for(let s of slt){
			let toggle = `<input onchange="checkSpecialOption(${skey})" class="special-form-toggle" type='checkbox'>`
	...
	function checkSpecialOption(skey){
		...
		$$('special-form-toggle')[skey].checked = true

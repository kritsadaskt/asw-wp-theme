...
<div id="loan_calc_section" class="py-12">
  <div class="cont-pd">
    <div class="flex flex-col items-center w-full">
      <h2 class="text-4xl font-medium lg:text-5xl mx-auto text-[#124375] mb-4 lg:mb-10">โปรแกรมคำนวณสินเชื่อ</h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div class="bg-[#124375] order-1 lg:order-2 p-4 lg:p-6 shadow-[7px_7px_0_rgba(0,0,0,0.5)] lg:shadow-[10px_10px_0px_rgba(0,0,0,0.5)] flex flex-col gap-2 justify-center mb-4 lg:mb-0">
                ...
                <div id="calculationResults" class="flex flex-col gap-4">
                  ...
                  <p class="text-neutral-100 text-center text-[16px] md:text-[18px] font-light lg:block">*การคำนวณนี้เป็นการประมาณการยอดเงินกู้ได้สูงสุดเพื่อที่อยู่อาศัย<br/>

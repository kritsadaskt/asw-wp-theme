    ...
    <theboxes class="top spacing -clip">
      <box col="4">
        <inner class="">
          ...
          <a href="/<?=pll_current_language()?>/loan-calculator/" title="<?php pll_e('โปรแกรมคำนวนสินเชื่อ') ?>" class="flex items-center gap-2 border-[0.5px] border-[#a3aab0] rounded-[5px] px-7 py-1 w-[250px] mt-4">
        ...
        <inner class="">
          ...
          <div class="pt-3">
            <div class="flex justify-between items-center" onclick="footer_togg(1,this)" data-show="-1">
              <h6 class=""><?php pll_e('โครงการตามทำเล') ?></h6>
              <div id="arrow" class="mobile-only arrow_footer"></div>
            </div>
            <div class="foot-toggle">
              <?php
                wp_nav_menu(array(
                  'menu' => 'Footer Projects by Locations',
                  'items_wrap'     => '%3$s',
                  'container'      => false,
                  'walker' => new Footer_P_Walker(),
                ));
              ?>
            </div>
          </div>
      ...
      <box col="2">
        <inner class="">
          <sp class="mobile-only" style="height: 0.5px;background-color: #545E67"></sp>
          <div class="pt-3 pb-3">
            <div class="flex justify-between items-center" onclick="footer_togg(4,this)" data-show="-1">

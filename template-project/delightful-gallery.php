	...
	<div class="-cont-pd py-10 section-fade gallery-main-wrap">
		...
		<div class="gallery-wrap">
			<?php switch (ofsize($content['gallery'])):
                ...
                <style>
                .gallery-group {
                    width: calc(var(--container) * 0.8) !important;
                    aspect-ratio: 905/505 !important;
                }
                .gallery-group-item {
                ...
                .gallery-nav-wrap {
                    --g: 2 !important;
                    --max: <?= ceil((ofsize($content['gallery']) / 3)) ?> !important;
                }

                .gallery-nav-line-bar {
                    width: calc(50% / (var(--max))) !important;
                    left: calc(50% / (var(--max)) * var(--i)) !important;
                }

                .gallery-rail {
                    --w: calc(var(--container) * var(--g) / (100/85)) !important;
                ...
                <style>
                .gallery-nav-wrap {
                    --g: <?= ceil(ofsize($content['gallery']) / 3) ?> !important;
                    --max: <?= ceil((ofsize($content['gallery']) / 3)) ?> !important;
                }
                ...
                .gallery-rail {
                    --w: calc(var(--container) * var(--g) / (100/62)) !important;
                    width: var(--w) !important;
                }

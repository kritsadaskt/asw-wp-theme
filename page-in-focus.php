...
<div class="pl-10 pt-8 flex flex-row items-center">
	<a href="/<?=pll_current_language()?>/home" class="cl-ci-blue-400"><?= pll__('หน้าแรก') ?></a>
	<img src="/wp-content/uploads/2023/01/Vector-84-1.png" style="margin:0px 12px;width: 7px;">
	<a href="/<?=pll_current_language()?>/about-us" class=""><?= pll__('รู้จักแอสเซทไวส์') ?></a>
</div>
<sp class=""></sp>
		...
		<div class="grid grid-flow-row lg:grid-cols-12 gap-4">
			...
			<div id="reward-asw" class="lg:col-span-9">
				...
				<?php
					...
					<a href="<?php the_permalink(); ?>" class="in-focus-block bg-ci-grey-900 h-full p-4 relative pointer">
						<img src="<?php the_post_thumbnail_url('large'); ?>" alt="<?php the_title(); ?>" class="aspect-square mb-4">
						<h4 class="text-2xl font-medium leading-none"><?php the_title(); ?></h4>
					</a>
